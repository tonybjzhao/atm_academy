...
class ReplayPilotRadioCall {
  final double timestampSec;
  final String callsign;
  final String text;

  const ReplayPilotRadioCall({
...
class ReplayWarningCue {
  final double timestampSec;
  final String type;

  const ReplayWarningCue({
    required this.timestampSec,
    required this.type,
  });
...
class ScenarioReplayData {
  ...
  // Optional audio timeline (for replay immersion)
  final List<ReplayPilotRadioCall> pilotRadioCalls;
  final List<ReplayWarningCue> warningCues;
  ...
  const ScenarioReplayData({
    ...
    this.pilotRadioCalls = const [],
    this.warningCues = const [],
  });
  ...
  String toJson() => jsonEncode({
        ...
        'pilotRadioCalls': pilotRadioCalls.map((e) => e.toMap()).toList(),
        'warningCues': warningCues.map((e) => e.toMap()).toList(),
      });
}
